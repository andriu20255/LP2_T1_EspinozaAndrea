...
public class DlgEquipoDental extends JDialog implements ActionListener {
	...
	private static final Object Dentista = null;
	...
	void listar() {
		...
		try {
			List<EquipoDental> lstOrdenes = manager.createQuery(jpql, EquipoDental.class).getResultList();

			for (EquipoDental equipoDental : lstOrdenes) {
			    ...
			    imprimir("Costo..............: " + "S/. " + equipoDental.getCosto());
			    imprimir("Fecha adquisición..: " + equipoDental.getFechaAdquisicion());
	...
	void adicionar() {
	    ...
	    String estado = txtCosto.getText(); 
	    ...
	    try {
	        ...
	        EquipoDental equipoDental = new EquipoDental(null, nombre, costo, fechaAdquisicion, estado, dentista);
